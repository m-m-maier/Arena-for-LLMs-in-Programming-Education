...
describe('Authority e2e test', () => {
	...
	const authoritySample = { name: '3aaa4805-4dc6-4340-9142-99513d60b5a2' };
	...
	describe('new Authority page', () => {
		...
		it('should create an instance of Authority', () => {
			cy.get(`[data-cy="name"]`).type('3c7a6553-c251-4433-9f67-e57153cf5847');
			cy.get(`[data-cy="name"]`).should('have.value', '3c7a6553-c251-4433-9f67-e57153cf5847');
